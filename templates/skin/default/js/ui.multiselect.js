...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedList.height(/*Math.max(this.element.height()-this.selectedActions.height(),1)*/ '400px');
		this.availableList.height(/*Math.max(this.element.height()-this.availableActions.height(),1)*/ '400px');

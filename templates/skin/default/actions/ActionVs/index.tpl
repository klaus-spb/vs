...
<div class="turnirmenu">
	<ul>
		<li><a href="/users/Walz/"><span class="bgr"><span class="bgl"><span class="bgi">{$aLang.plugin.vs.profile}</span></span></span></a></li>
		<li class="active"><a href="/users/Walz/posts/"><span class="bgr"><span class="bgl"><span class="bgi">{$aLang.plugin.vs.posts} <i>(0)</i></span></span></span></a></li>
		<li><a href="/users/Walz/comments/"><span class="bgr"><span class="bgl"><span class="bgi">{$aLang.plugin.vs.comments}<i>(9)</i></span></span></span></a></li>
		<li><a href="/users/Walz/favs/"><span class="bgr"><span class="bgl"><span class="bgi">{$aLang.plugin.vs.favorite} <i>(2)</i></span></span></span></a></li>

...
<head>
	...
	<script type="text/javascript">
		...
		{/foreach}
 var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-24867504-1']);
_gaq.push(['_setDomainName', 'virtualsports.ru']);
...
{if $oUserCurrent } 
<link type="text/css" href="http://virtualsports.ru/chat/cometchatcss.php" rel="stylesheet" charset="utf-8">
<script type="text/javascript" src="http://virtualsports.ru/chat/cometchatjs.php" charset="utf-8"></script>
{/if}
	...
	<div id="container" class="{hook run='container_class'}">
		{include file="$sTPLvs/actions/ActionTeam/header_top.tpl"} 

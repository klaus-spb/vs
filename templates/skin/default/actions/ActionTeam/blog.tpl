...
<div class="blog">
	<header class="blog-header">
            ...
            {if $oUserCurrent and ($oUserCurrent->getId()==$oBlog->getOwnerId() or $oUserCurrent->isAdministrator() or $oBlog->getUserIsAdministrator() )}
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{router page='blog'}admin/{$oBlog->getId()}/" title="{$aLang.blog_admin}" class="edit"><i class="icon-user"></i>{$aLang.blog_admin}</a>
                        </li>
                        <li>
                            <a href="{router page='blog'}edit/{$oBlog->getId()}/" title="{$aLang.blog_edit}" class="edit"><i class="icon-edit"></i>{$aLang.blog_edit}</a>
                        </li>
                        <li>
		...
		<ul class="actions">
			...
			{/if}
				<li>
					<a href="{router page='content'}topic/add/?blog_id={$oBlog->getId()}" class="blue">
                        <i class="icon-pencil"></i> {$aLang.topic_topic_create}
                    </a>
				</li> 
		</ul>
	</header>
...
<div class="nav-filter-wrapper blog-nav">
	<ul>
		<li class="btn-group{if $sMenuSubItemSelect=='good'} active{/if}"><a href="{$sMenuSubBlogUrl}" class="btn">{$aLang.blog_menu_collective_good}</a></li>

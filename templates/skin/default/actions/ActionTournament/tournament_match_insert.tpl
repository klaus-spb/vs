...
<p align="center">
		...
		<p align="center">
			<input id="inputaway_teamplay" name="inputaway_teamplay" class="input-mini" {if $teamtournament_result==$oMatch->getAwayTeamtournament()}onKeyUp="MyAdd(this.value)"{/if} type="text" SIZE="2" maxlength="2" {if $oMatchResult}value="{$oMatchResult->getAway()}"{/if}/>:<input id="inputhome_teamplay"  name="inputhome_teamplay" class="input-mini" type="text" {if $teamtournament_result==$oMatch->getHomeTeamtournament()}onKeyUp="MyAdd(this.value)"{/if} SIZE="2" maxlength="2" {if $oMatchResult}value="{$oMatchResult->getHome()}"{/if}/> <span id="span_exist_o_teamplay" {if $oTournament->getExistO()==0}style="display:none;"{/if}>
...
P.<select id="period{$num}" name="period{$num}" class="width_auto">
...
M.<select id="minute{$num}" name="minute{$num}" class="width_auto"><option value="{$oMatchgoal->getMinute()}">{$oMatchgoal->getMinute()}</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option></select> 
S. <select id="secunde{$num}" name="secunde{$num}" class="width_auto"><option value="{$oMatchgoal->getSecunde()}">{$oMatchgoal->getSecunde()}</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option></select> 
G. <select id="goal{$num}" name="goal{$num}" class="input-small"><option value="0" {if $oMatchgoal->getGoal()==0}SELECTED{/if}>{$aLang.plugin.vs.bot}</option>
...
1a. <select id="assist_{$num}" name="assist_{$num}" class="input-small"><option value="0" {if $oMatchgoal->getAssist()==0}SELECTED{/if}>{$aLang.plugin.vs.bot}</option><option value="-1" {if $oMatchgoal->getAssist()==-1}SELECTED{/if}>-</option>
...
2a. <select id="assist__{$num}" name="assist__{$num}" class="input-small"><option value="0" {if $oMatchgoal->getAssist2()==0}SELECTED{/if}>{$aLang.plugin.vs.bot}</option><option value="-1" {if $oMatchgoal->getAssist2()==-1}SELECTED{/if}>-</option>
...
<select id="sostav{$num}" name="sostav{$num}" class="input-small">
...
<table>  
 <tr>
  <td ><h1>{$aLang.plugin.vs.players}</h1></td>
  </tr>
...
<tr>
	<td class="td_team_center">
		{foreach from=$position.params item=param key=key name=el2}
			...
			{$param}:<input name="{$key}{$position.num}" class="input-mini" type="text" id="{$key}{$position.num}" size="5" 
			{if $aMatchplayerstat}
				{foreach from=$aMatchplayerstat item=oMatchplayerstat}
				{if $position.brief==$oMatchplayerstat->getPosition() }
...
{/foreach}
 <tr>
  ...
  <tr class="odd">
   ...
   <td colspan="3" class="td_team_center"><input name="pp_r" class="input-mini" type="text" id="pp_r" size="2" {if $oMatchResult}value="{$oMatchResult->getPowerplayRealize()}"{/if}/>/<input name="pp" class="input-mini" type="text" id="pp" {if $oMatchResult}value="{$oMatchResult->getPp()}"{/if} size="2" />
<input name="penalties" class="input-mini" type="hidden" id="penalties" value="0" size="2" /></td>

  </tr>

  <tr class="even">
   <td class="td_team_center">{$aLang.plugin.vs.faceoff} (won)</td>
   <td class="td_team_center" colspan="3"><input name="faceoff_win" class="input-mini" type="text" id="faceoff_win" {if $oMatchResult}value="{$oMatchResult->getFaceoffWin()}"{/if} size="2" /></td>
<tr class="odd">
   <td class="td_team_center">{$aLang.plugin.vs.tia}</td>
   <td class="td_team_center" colspan="3">Minutes<SELECT id="minute_at" NAME="minute_at" class="width_auto">{if $oMatchResult}<OPTION value={$oMatchResult->getMinuteAt()}>{$oMatchResult->getMinuteAt()}</OPTION>{/if}<OPTION value=0>0</OPTION><OPTION value=1>1</OPTION><OPTION value=2>2</OPTION><OPTION value=3>3</OPTION><OPTION value=4>4</OPTION><OPTION value=5>5</OPTION><OPTION value=6>6</OPTION><OPTION value=7>7</OPTION><OPTION value=8>8</OPTION><OPTION value=9>9</OPTION><OPTION value=10>10</OPTION><OPTION value=11>11</OPTION><OPTION value=12>12</OPTION><OPTION value=13>13</OPTION><OPTION value=14>14</OPTION><OPTION value=15>15</OPTION><OPTION value=16>16</OPTION><OPTION value=17>17</OPTION><OPTION value=18>18</OPTION><OPTION value=19>19</OPTION><OPTION value=20>20</OPTION><OPTION value=21>21</OPTION><OPTION value=22>22</OPTION><OPTION value=23>23</OPTION><OPTION value=24>24</OPTION><OPTION value=25>25</OPTION><OPTION value=26>26</OPTION><OPTION value=27>27</OPTION><OPTION value=28>28</OPTION><OPTION value=29>29</OPTION><OPTION value=30>30</OPTION><OPTION value=31>31</OPTION><OPTION value=32>32</OPTION><OPTION value=33>33</OPTION><OPTION value=34>34</OPTION><OPTION value=35>35</OPTION><OPTION value=36>36</OPTION><OPTION value=37>37</OPTION><OPTION value=38>38</OPTION><OPTION value=39>39</OPTION><OPTION value=40>40</OPTION><OPTION value=41>41</OPTION><OPTION value=42>42</OPTION><OPTION value=43>43</OPTION><OPTION value=44>44</OPTION><OPTION value=45>45</OPTION><OPTION value=46>46</OPTION><OPTION value=47>47</OPTION><OPTION value=48>48</OPTION><OPTION value=49>49</OPTION><OPTION value=50>50</OPTION><OPTION value=51>51</OPTION><OPTION value=52>52</OPTION><OPTION value=53>53</OPTION><OPTION value=54>54</OPTION><OPTION value=55>55</OPTION><OPTION value=56>56</OPTION><OPTION value=57>57</OPTION><OPTION value=58>58</OPTION><OPTION value=59>59</OPTION></SELECT>seconds<SELECT id="secunde_at" NAME="secunde_at" class="width_auto">{if $oMatchResult}<OPTION value={$oMatchResult->getSecundeAt()}>{$oMatchResult->getSecundeAt()}</OPTION>{/if}<OPTION value=0>0</OPTION><OPTION value=1>1</OPTION><OPTION value=2>2</OPTION><OPTION value=3>3</OPTION><OPTION value=4>4</OPTION><OPTION value=5>5</OPTION><OPTION value=6>6</OPTION><OPTION value=7>7</OPTION><OPTION value=8>8</OPTION><OPTION value=9>9</OPTION><OPTION value=10>10</OPTION><OPTION value=11>11</OPTION><OPTION value=12>12</OPTION><OPTION value=13>13</OPTION><OPTION value=14>14</OPTION><OPTION value=15>15</OPTION><OPTION value=16>16</OPTION><OPTION value=17>17</OPTION><OPTION value=18>18</OPTION><OPTION value=19>19</OPTION><OPTION value=20>20</OPTION><OPTION value=21>21</OPTION><OPTION value=22>22</OPTION><OPTION value=23>23</OPTION><OPTION value=24>24</OPTION><OPTION value=25>25</OPTION><OPTION value=26>26</OPTION><OPTION value=27>27</OPTION><OPTION value=28>28</OPTION><OPTION value=29>29</OPTION><OPTION value=30>30</OPTION><OPTION value=31>31</OPTION><OPTION value=32>32</OPTION><OPTION value=33>33</OPTION><OPTION value=34>34</OPTION><OPTION value=35>35</OPTION><OPTION value=36>36</OPTION><OPTION value=37>37</OPTION><OPTION value=38>38</OPTION><OPTION value=39>39</OPTION><OPTION value=40>40</OPTION><OPTION value=41>41</OPTION><OPTION value=42>42</OPTION><OPTION value=43>43</OPTION><OPTION value=44>44</OPTION><OPTION value=45>45</OPTION><OPTION value=46>46</OPTION><OPTION value=47>47</OPTION><OPTION value=48>48</OPTION><OPTION value=49>49</OPTION><OPTION value=50>50</OPTION><OPTION value=51>51</OPTION><OPTION value=52>52</OPTION><OPTION value=53>53</OPTION><OPTION value=54>54</OPTION><OPTION value=55>55</OPTION><OPTION value=56>56</OPTION><OPTION value=57>57</OPTION><OPTION value=58>58</OPTION><OPTION value=59>59</OPTION></SELECT></td>

 <tr class="even">
   <td class="td_team_center">{$aLang.plugin.vs.pass_perc}</td>
   <td class="td_team_center" colspan="3"><input name="pass_prc" class="input-mini" type="pass" id="pass_prc" {if $oMatchResult}value="{$oMatchResult->getPassPrc()}"{/if} size="3" /></td>

  </tr>
 <tr class="odd">
    <td class="td_team_center">1st star</td>
	 <td colspan="3" class="td_team_center"><SELECT id="star1" NAME="star1" ><option value="-1">-</option><option value="0">Bot</option>
									{foreach from=$aPlayercards item=oPlayercards name=el2}
									{assign var=oUser value=$oPlayercards->getUser()}									
...
<tr class="even">
    <td class="td_team_center">2nd star</td>
	 <td colspan="3" class="td_team_center"><SELECT id="star2" NAME="star2"><option value="-1">-</option><option value="0">Bot</option>
									{foreach from=$aPlayercards item=oPlayercards name=el2}
									{assign var=oUser value=$oPlayercards->getUser()}									
...
<tr class="odd">
    <td class="td_team_center">3rd star</td>
	 <td colspan="3" class="td_team_center"><SELECT id="star3" NAME="star3"><option value="-1">-</option><option value="0" {if $oMatchResult && $oMatchResult->getStar3()==0}SELECTED{/if}>Bot</option>
									{foreach from=$aPlayercards item=oPlayercards name=el2}
									{assign var=oUser value=$oPlayercards->getUser()}									
...
if ((sostav=="3") && (assist_ !="-1")) errorList.push(3);
if ((sostav=="3") && (assist__ !="-1")) errorList.push(3);
}
...
<form action="{$oBlog->getUrlFull()}turnir/{$oTournament->getUrl()}/_match_insert/{$oMatch->getMatchId()}{if $teamtournament_result!=$myteamtournament}/{$teamtournament_result}{/if}" onsubmit="return checkForm(this);"  method="post" id="form1" name="form1">
 
<p align="center">
			<span id="match_teams_teamplay"></span>
		</p>
		<p align="center">
			<input id="inputaway_teamplay" name="inputaway_teamplay" {if $teamtournament_result==$oMatch->getAwayTeamtournament()}onKeyUp="MyAdd(this.value)"{/if} type="text" SIZE="2" maxlength="2" {if $oMatchResult}value="{$oMatchResult->getAway()}"{/if}/>:<input id="inputhome_teamplay"  name="inputhome_teamplay" type="text" {if $teamtournament_result==$oMatch->getHomeTeamtournament()}onKeyUp="MyAdd(this.value)"{/if} SIZE="2" maxlength="2" {if $oMatchResult}value="{$oMatchResult->getHome()}"{/if}/> <span id="span_exist_o_teamplay" {if $oTournament->getExistO()==0}style="display:none;"{/if}>
			<input id="ot_teamplay" name="ot_teamplay" type="checkbox" value="1" {if $oMatchResult && $oMatchResult->getOt()==1}CHECKED="CHECKED"{/if}/>ОТ </span><span id="span_exist_b_teamplay" {if $oTournament->getExistB()==0}style="display:none;"{/if}> <input id="so_teamplay" name="so_teamplay" type="checkbox" value="1"/>/ SO</span> <span id="vvel_teamplay"></span>
		</p>
				<p>
			<div id="divTxt">
...
G. <select id="goal{$num}" name="goal{$num}"><option value="0" {if $oMatchgoal->getGoal()==0}SELECTED{/if}>Bot</option>
...
1a. <select id="assist_{$num}" name="assist_{$num}"><option value="0" {if $oMatchgoal->getAssist()==0}SELECTED{/if}>Bot</option><option value="-1" {if $oMatchgoal->getAssist()==-1}SELECTED{/if}>-</option>
...
2a. <select id="assist__{$num}" name="assist__{$num}"><option value="0" {if $oMatchgoal->getAssist2()==0}SELECTED{/if}>Bot</option><option value="-1" {if $oMatchgoal->getAssist2()==-1}SELECTED{/if}>-</option>
...
{if $oMatchResult}inserted - {$oMatchResult->getDates()}{/if}
